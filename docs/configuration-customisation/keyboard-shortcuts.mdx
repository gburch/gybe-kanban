...
Use these shortcuts to jump straight to the first nine projects shown in the project switcher. The numbering matches the order of projects in the dropdown menu.

| Shortcut | Platform | Description |
|----------|----------|-------------|
| `Ctrl + 1` … `Ctrl + 9` | macOS | Open the matching project board from anywhere the project switcher is available |
| `Ctrl + Alt + 1` … `Ctrl + Alt + 9` | Windows/Linux | Open the matching project board from anywhere the project switcher is available |
