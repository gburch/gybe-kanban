...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        executors::payload::ExecutorPayload::decl(),
        executors::payload::ExecutorRepositoryContext::decl(),
        ...
        server::routes::task_attempts::AttemptRepositorySelection::decl(),
        ...
        server::activity_feed::ActivityFeedScope::decl(),
        ...
        db::models::task_attempt_repository::TaskAttemptRepository::decl(),
